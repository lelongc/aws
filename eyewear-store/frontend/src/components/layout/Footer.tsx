      ...
      <div className="container mx-auto px-4 py-12 sm:px-6 lg:py-16">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            <div className="flex items-center">
              ...
              />
              <span className="ml-2 text-lg font-bold text-white">Eyewear Store</span>
            </div>
            <p className="text-base text-gray-300">
              Making the world see better, one frame at a time.
            </p>
          ...
          <div className="mt-12 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-base font-medium text-white">Shop</h3>
        ...
        <div className="mt-12 border-t border-gray-700 pt-8">
          <p className="text-base text-gray-400 xl:text-center">
            &copy; {new Date().getFullYear()} Eyewear Store, Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
