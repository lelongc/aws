...
#### **Cơ chế hoạt động:**
1. **Baseline refill:**
   - Tốc độ IOPS cơ bản phụ thuộc vào kích thước volume:
     - **3 IOPS/GB**, hoặc tối thiểu **100 IOPS** (cho volume nhỏ hơn 33.33GB).
   - Ví dụ:
...
??? info "cách hoạt động của AWS EBS khi IOPS vượt quá 30,000:
    ...
    - Nếu bạn sử dụng **GP2 volume**:
      ...
      - Ví dụ:
        - Volume 2TB → **60,000 IOPS** (2TB × 30 IOPS/GB).
    ...
    - Với **GP3**:
      ...
      - Ví dụ:
        - Tăng từ 3,000 IOPS lên 10,000 IOPS → Bạn sẽ bị tính thêm tiền.
